...
const Adminhome = () => {
    ...
    const [serviceFilter, setServiceFilter] = useState(null); // State for service filter
    ...
    return (
        <div className="flex min-h-screen w-372 -mt-30 bg-gray-100">
            {/* Sidebar */}
            <div className="fixed left-0 top-0 w-68 h-full bg-[#1557b3] text-white p-4 flex flex-col justify-between shadow-lg hidden md:flex">
                <ul className="space-y-3 mt-20">
                    <li className="relative">
                        ...
                        {isDropdownOpen && (
                            <ul className="mt-2 bg-blue-800 text-white rounded shadow-lg">
                                <li>
                                    <button
                                        onClick={() => handleServiceFilter("lawyer")}
                                        className="block p-2 hover:bg-blue-600 w-full text-left"
                                    >
                                        Lawyers
                                    </button>
                                </li>
                                <li>
                                    <button
                                        onClick={() => handleServiceFilter("doctor")}
                                        className="block p-2 hover:bg-blue-600 w-full text-left"
                                    >
                                        Doctors
                                    </button>
                                ...
                                <li>
                                    <button
                                        onClick={() => handleServiceFilter("banking")}
                                        className="block p-2 hover:bg-blue-600 w-full text-left"
                                    >
                                        Banking
                                    </button>
                                ...
                                <li>
                                    <button
                                        onClick={() => handleServiceFilter("other")}
                                        className="block p-2 hover:bg-blue-600 w-full text-left"
                                    >
                                        Others
                                    </button>
                    ...
                    <li>
                        <Link to="/help" className="block bg-blue-600 hover:bg-blue-700 p-2 rounded">
                            Help
                        </Link>
                    </li>
                </ul>
            ...
            <div className="ml-64 flex flex-col mt-50 w-full">
                <div className="justify-center text-center -ml-130">
                    <Adminpost filterService={serviceFilter} />
                </div>
                {/* Footer Section */}
                <footer className="footer">
                    <div className="container">
                        ...
                        <div className="section">
                            ...
                            <p className="section-text">
                                Sadha Mee Seva Lo offers a seamless connection to essential services like legal assistance, healthcare, banking, and more. We strive to make your service journey hassle-free.
                            </p>
                        </div>
                    ...
                    <div className="copyright">© 2025 Sadha Mee Seva Lo. All rights reserved.</div>
                </footer>
            </div>
        </div>
    );
